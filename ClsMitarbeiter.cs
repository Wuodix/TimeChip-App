...
namespace TimeChip_App_1._0
{
    ...
    {
        int m_id; //Id ist von der Datenbank zugewiesen, Mitarbeiternummer wird vom Arduino zugewiesen
        ...
        public ClsMitarbeiter(int ID, string Vorname, string Nachname, ClsArbeitsprofil Arbeitszeitprofil, DateTime Arbeitsbeginn, TimeSpan Urlaub, TimeSpan Überstunden)
        {
            m_id = ID;
            m_vorname = Vorname;
            m_nachname = Nachname;
        ...
        public string Log()
        {
            return m_id + " - " + m_vorname + " - " + m_nachname + " - " + m_überstunden + " - " + m_urlaub;
        }
    }
}
